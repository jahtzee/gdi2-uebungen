...
public class QuizGUI2 extends javafx.application.Application {

	@Override
	public void start(Stage primaryStage) throws Exception {

		// placeholder labels
		Label labelTop = new Label("Quizfrage:");
		Label textbox = new Label("Fragetext");
		...
		Button button = new Button("Antworten");
		...
		primaryStage.setTitle("Wer wird Millionär - Quiz");
		primaryStage.show();
